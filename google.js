...
//ie 文本框内容 缓存清除
 zhh.two = function(data){     //搜索切换
	...
	//window.open("http://www.1m2a.com/index.php/vod/search.html?wd="+data,bf)
		//s2
	//window.open("http://www.fian.vip/seacher.php?sousuo="+data,bf)
    }
}
// function on(e,fn){
...
function ip_go(data){
	  ...
	  if(ct.length < 1){
        ...
        dScr.src = "https://www.tianqiapi.com/api/?version=v1&appid=93973758&appsecret='BSuSZg9r'&cityid="+ct+"&callback=dcb1"; 
